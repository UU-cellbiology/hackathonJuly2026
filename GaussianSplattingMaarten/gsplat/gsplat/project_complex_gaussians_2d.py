...
def project_complex_gaussians_2d(
    ...
    """
    return _ProjectComplexGaussians2d.apply(
        means2d.contiguous(),
...
class _ProjectComplexGaussians2d(Function):
    ...
    def forward(
        ...
        (
            ...
            conics,
            num_tiles_hit,
        ) = _C.project_complex_gaussians_2d_forward(
            num_points,
            means2d,
            L_elements,
            img_height,
    ...
    def backward(ctx, v_xys, v_depths, v_radii, v_conics, v_num_tiles_hit):
        ...
        (v_cov2d, v_mean2d, v_L_elements) = _C.project_complex_gaussians_2d_backward(
            ctx.num_points,
            means2d,
            L_elements,
            ctx.img_height,
